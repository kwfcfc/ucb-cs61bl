...
public class LinkedListPreconditionTest {

    /** Returns the inner class of lld. Asserts there is exactly two inner classes. */
    private static Class<?> getLldInnerClass() {
        Class<?>[] innerClasses = LinkedListDeque61B.class.getDeclaredClasses();
        assertWithMessage("LinkedListDeque61B should have exactly two inner classes").that(innerClasses).hasLength(2);
